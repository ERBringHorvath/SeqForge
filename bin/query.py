...
def run_multiblast(args):
    ...
    if args.visualize and not args.report_strongest_matches:
        msg = "Error: --visualize may only be run with --report-strongest-matches"
        print(f"\n\033[91m{msg}\033[0m")
        logger.warning(msg)
        return
    ...
    if using_motif:
        ...
        for _, row in df.iterrows():
            ...
            try:
                ...
                logger.error(f"Error matching {gene_id}: {e}")
