...
def run_multiblast(args):
    ...
    if os.path.isdir(db_dir):
        ...
        if db_dir.endswith(('.nhr', '.phr')):
            ...
            print(f"\033[91mError: Provided file must end in .nhr or .phr\033[0m")
            return
    ...
    for db_path in db_basenames:
        ...
        if os.path.exists(db_path + ".nhr"):
            ...
            print(f"\033[93mWarning: No valid .nhr or .phr file found for {db_path}\033[0m")
    ...
    for query_file_path in query_files:
        ...
        for db_file in db_basenames:
            ...
            if not db_type:
                print(f"\033[91mError: Could not determine type for database {basename}\033[0m")
                continue
    ...
    if using_motif:
        ...
        for _, row in df.iterrows():
            ...
            if not sequence:
                print(f"\033[93mWarning: No FASTA record found for {gene_id}\033[0m")
                continue
            ...
            try:
                ...
                print(f"\033[91mError matching {gene_id}: {e}\033[0m")
        ...
        if motif_hits:
            ...
            print("\n\033[93mNo motif matches found.\033[0m")
