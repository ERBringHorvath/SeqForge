...
def process_contig_entry(row, fasta_dir, evalue, min_perc, min_cov, extracted_contigs, lock, *, logger):
...
def extract_contigs_from_csv(csv_path, fasta_dir, output_fasta, evalue=1e-5, min_perc=90.0, min_cov=75.0,
                             *, logger):
